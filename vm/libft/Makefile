...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/29 17:04:20 by oposhiva          #+#    #+#              #
#    Updated: 2016/11/29 17:04:21 by oposhiva         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
ft_lstiter.c ft_lstmap.c ft_vig_coder.c ft_vig_decoder.c \
ft_strrev.c ft_max_div.c ft_abs.c 
...
ft_strrev.o ft_max_div.o ft_abs.o 
